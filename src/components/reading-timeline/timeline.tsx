...
const books: BookEntry[] = [
  ...
  },
  {
    ...
    bestQuoteInBook:
      "Every hour, I feel as if the chimes of the previous hour have just sounded.",
  },
  {
  ...
  },
  {
    ...
    bestQuoteInBook:
      "Seeing one person after another, I realize that in fact, I love no one.",
  },
  {
  ...
  },
  {
    ...
    bestQuoteInBook:
      "Any act of sexual violence is something the entire society commits together.",
  },
  {
    title: "Walden",
    ...
    <div className="min-h-screen p-20">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="relative">
          <div className="absolute left-1/2 h-full w-0.5 -translate-x-1/2 bg-card-foreground/30" />
                  ...
                  <Tooltip>
                    ...
                    {book.bestQuoteInBook && (
                      <TooltipContent
                        ...
                        sideOffset={15}
                        className="border-[0.01rem] border-card-foreground/50 bg-transparent text-card-foreground"
                      >
                        <p className="w-36 max-w-max md:w-48">
                          {book.bestQuoteInBook}
                        </p>
                      </TooltipContent>
                    )}
