...
const GlowingShell = () => {
  ...
  return (
    <button
      className="group absolute bottom-16 right-8 flex items-center justify-center md:bottom-32 md:left-1/2 md:right-auto md:-translate-x-1/2"
      onClick={() => {
    ...
    >
      <div className="relative">
        <div className="absolute -inset-4 animate-pulse rounded-full bg-yellow-500/20 blur-xl group-hover:bg-yellow-500/60" />
        <div className="relative size-8 rounded-full bg-yellow-500/40 p-2 shadow-lg transition-all duration-300 group-hover:bg-yellow-500/60">
          <svg
