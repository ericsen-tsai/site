import { Avatar, AvatarFallback, AvatarImage, Button } from "@erichandsen/ui";
...
function LocationLink({ location, locationLink }: LocationLinkProps) {
  return (
    <p className="text-foreground max-w-md items-center text-pretty font-mono text-xs">
      <a
...
interface ContactButtonsProps {
  contact: Partial<typeof RESUME_DATA.contact>;
  ...
  return (
    <header className="flex items-center justify-between">
      <div className="flex-1 space-y-1.5">
        ...
        <p
          className="text-foreground/80 max-w-md text-pretty font-mono text-sm print:text-[12px]"
